...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class SecureTransactionDetailDTO : IValidatableObject
    {
        ...
        /// <param name="maskedReferenceCustomerId">maskedReferenceCustomerId.</param>
        /// <param name="customerAccountId">customerAccountId.</param>
        /// <param name="maskedCustomerAccountId">maskedCustomerAccountId.</param>
        ...
        /// <param name="maskedRecurringId">maskedRecurringId.</param>
        ...
        /// <param name="maskedPartnerId">maskedPartnerId.</param>
        /// <param name="orderId">orderId.</param>
        /// <param name="maskedOrderId">maskedOrderId.</param>
        ...
        public SecureTransactionDetailDTO(string transactionId = default(string), string traceNumber = default(string), string transactionCode = default(string), TransactionOriginEnum? transactionOrigin = default(TransactionOriginEnum?), TransactionPaymentResponseBillingContact billingContact = default(TransactionPaymentResponseBillingContact), TransactionPaymentResponseBillingContact shippingContact = default(TransactionPaymentResponseBillingContact), string referenceTransactionId = default(string), string transactionDate = default(string), string merchantId = default(string), string ipAddress = default(string), OperationTypeEnum? operationType = default(OperationTypeEnum?), ChannelTypeEnum? channelType = default(ChannelTypeEnum?), ProcessMethodEnum? processMethod = default(ProcessMethodEnum?), string processorName = default(string), bool isDebit = default(bool), SecureTransactionDetailDTOTenderInfo tenderInfo = default(SecureTransactionDetailDTOTenderInfo), int referenceCustomerId = default(int), string maskedReferenceCustomerId = default(string), int customerAccountId = default(int), string maskedCustomerAccountId = default(string), string invoiceNo = default(string), string poNo = default(string), string referenceNo = default(string), string remarks = default(string), RecurringTypeEnum? recurringType = default(RecurringTypeEnum?), int recurringId = default(int), string maskedRecurringId = default(string), int installmentNumber = default(int), int installmentCount = default(int), bool allowDuplicates = default(bool), bool verificationEnabled = default(bool), bool sentSuccessNotification = default(bool), bool sentFailedNotification = default(bool), bool trainingMode = default(bool), string terminalId = default(string), bool isOffline = default(bool), TransactionStatusEnum? transactionStatus = default(TransactionStatusEnum?), PreviousTransactionStatusEnum? previousTransactionStatus = default(PreviousTransactionStatusEnum?), TransactionDetailResponseTransactionResult transactionResult = default(TransactionDetailResponseTransactionResult), int level = default(int), int partnerId = default(int), string maskedPartnerId = default(string), int orderId = default(int), string maskedOrderId = default(string), string invoiceId = default(string), string maskedInvoiceId = default(string), string paymentLinkId = default(string), string maskedPaymentLinkId = default(string), string additionalFields = default(string), string settlementDate = default(string), string issuer = default(string), string paymentReference = default(string), string refundReference = default(string))
        {
            ...
            this.MaskedReferenceCustomerId = maskedReferenceCustomerId;
            this.CustomerAccountId = customerAccountId;
            this.MaskedCustomerAccountId = maskedCustomerAccountId;
            ...
            this.MaskedRecurringId = maskedRecurringId;
            ...
            this.MaskedPartnerId = maskedPartnerId;
            this.OrderId = orderId;
            this.MaskedOrderId = maskedOrderId;
        ...
        /// <summary>
        /// Gets or Sets MaskedReferenceCustomerId
        /// </summary>
        [DataMember(Name = "maskedReferenceCustomerId", EmitDefaultValue = false)]
        public string MaskedReferenceCustomerId { get; set; }
        ...
        /// <summary>
        /// Gets or Sets MaskedCustomerAccountId
        /// </summary>
        [DataMember(Name = "maskedCustomerAccountId", EmitDefaultValue = false)]
        public string MaskedCustomerAccountId { get; set; }
        ...
        /// <summary>
        /// Gets or Sets MaskedRecurringId
        /// </summary>
        [DataMember(Name = "maskedRecurringId", EmitDefaultValue = false)]
        public string MaskedRecurringId { get; set; }
        ...
        /// <summary>
        /// Gets or Sets MaskedPartnerId
        /// </summary>
        [DataMember(Name = "maskedPartnerId", EmitDefaultValue = false)]
        public string MaskedPartnerId { get; set; }
        ...
        /// <summary>
        /// Gets or Sets MaskedOrderId
        /// </summary>
        [DataMember(Name = "maskedOrderId", EmitDefaultValue = false)]
        public string MaskedOrderId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  MaskedReferenceCustomerId: ").Append(MaskedReferenceCustomerId).Append("\n");
            sb.Append("  CustomerAccountId: ").Append(CustomerAccountId).Append("\n");
            sb.Append("  MaskedCustomerAccountId: ").Append(MaskedCustomerAccountId).Append("\n");
            ...
            sb.Append("  MaskedRecurringId: ").Append(MaskedRecurringId).Append("\n");
            ...
            sb.Append("  MaskedPartnerId: ").Append(MaskedPartnerId).Append("\n");
            sb.Append("  OrderId: ").Append(OrderId).Append("\n");
            sb.Append("  MaskedOrderId: ").Append(MaskedOrderId).Append("\n");
