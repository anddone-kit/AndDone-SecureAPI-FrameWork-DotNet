...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class SecureMerchantTokenShortResponse : IValidatableObject
    {
        ...
        public PaymentRequestBillingContactAddress Address { get; set; }
