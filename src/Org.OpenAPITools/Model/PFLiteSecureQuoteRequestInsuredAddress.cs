...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class PFLiteSecureQuoteRequestInsuredAddress : IValidatableObject
    {
        ...
        public PFLiteSecureQuoteRequestInsuredAddress(string address1 = default(string), string address2 = default(string), string city = default(string), string state = default(string), string zip = default(string), string phone = default(string))
        {
            ...
            if (phone == null)
            {
                throw new ArgumentNullException("phone is a required property for PFLiteSecureQuoteRequestInsuredAddress and cannot be null");
            }
            this.Phone = phone;
        }
