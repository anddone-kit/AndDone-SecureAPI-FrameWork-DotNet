...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TokenLinkSecureRequest_callbackParameters")]
    public partial class TokenLinkSecureRequestCallbackParameters : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TokenLinkSecureRequestCallbackParameters" /> class.
        /// </summary>
        ...
        public TokenLinkSecureRequestCallbackParameters(string callbackSuccessUrl = default(string), string callbackFailureUrl = default(string), string accessKey = default(string), string secretKey = default(string), string referenceNo = default(string), string referenceType = default(string), string transactionId = default(string), string callbackApiUrl = default(string), string callbackMessage = default(string), int redirectionTime = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TokenLinkSecureRequestCallbackParameters {\n");
