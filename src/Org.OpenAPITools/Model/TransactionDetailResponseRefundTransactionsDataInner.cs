...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransactionDetailResponse_refundTransactions_data_inner")]
    public partial class TransactionDetailResponseRefundTransactionsDataInner : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Defines CashIncentiveType
        /// </summary>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum CashIncentiveTypeEnum
        {
            /// <summary>
        ...
        public CashIncentiveTypeEnum? CashIncentiveType { get; set; }
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionDetailResponseRefundTransactionsDataInner" /> class.
        /// </summary>
        /// <param name="transactionId">transactionId.</param>
        /// <param name="maskedMerchantId">maskedMerchantId.</param>
        ...
        public TransactionDetailResponseRefundTransactionsDataInner(string transactionId = default(string), string maskedMerchantId = default(string), string ipAddress = default(string), string transactionDate = default(string), OperationTypeEnum? operationType = default(OperationTypeEnum?), ChannelTypeEnum? channelType = default(ChannelTypeEnum?), ProcessMethodEnum? processMethod = default(ProcessMethodEnum?), bool isDebit = default(bool), string referenceTransactionId = default(string), int referenceCustomerId = default(int), string maskedReferenceCustomerId = default(string), int customerAccountId = default(int), string maskedCustomerAccountId = default(string), int recurringId = default(int), string maskedRecurringId = default(string), int batchId = default(int), TransactionStatusEnum? transactionStatus = default(TransactionStatusEnum?), string settlementDate = default(string), string authCode = default(string), string cardNumber = default(string), string accountNumber = default(string), string binNumber = default(string), string chequeNumber = default(string), string routingNumber = default(string), string nameOnCheckOrCard = default(string), string accountHolderName = default(string), AccountCategoryEnum? accountCategory = default(AccountCategoryEnum?), bool trainingMode = default(bool), decimal amount = default(decimal), decimal tipAmount = default(decimal), decimal convenienceAmount = default(decimal), decimal captureAmount = default(decimal), decimal taxPercent = default(decimal), decimal taxAmount = default(decimal), decimal surchagePercent = default(decimal), decimal surchageAmount = default(decimal), decimal cashDiscountPercent = default(decimal), decimal cashDiscountAmount = default(decimal), CashIncentiveTypeEnum? cashIncentiveType = default(CashIncentiveTypeEnum?), decimal cashIncentivePercent = default(decimal), decimal cashIncentiveAmount = default(decimal), decimal clinicAmount = default(decimal), decimal dentalAmount = default(decimal), decimal rxAmount = default(decimal), decimal visionAmount = default(decimal), string cardType = default(string), string createdOn = default(string), string createdBy = default(string), string modifiedOn = default(string), string modifiedBy = default(string), string customerName = default(string), int partnerId = default(int), string maskedPartnerId = default(string), string partnerName = default(string), int orderId = default(int), string maskedOrderId = default(string), int invoiceId = default(int), string maskedInvoiceId = default(string), int paymentLinkId = default(int), string maskedPaymentLinkId = default(string), string referenceNo = default(string), string processorName = default(string), string processorDisplayName = default(string), string processorCode = default(string), string verification2Code = default(string), TransactionOriginEnum? transactionOrigin = default(TransactionOriginEnum?), PreviousTransactionStatusEnum? previousTransactionStatus = default(PreviousTransactionStatusEnum?), string traceNumber = default(string), string merchantReference = default(string), string additionaFields = default(string), decimal adjustmentValue = default(decimal), decimal adjustmentFixedValue = default(decimal), decimal adjustmentAmount = default(decimal), string adjustmentDisplayName = default(string), string adjustmentDescriptorMessage = default(string), PaymentAdjustmentTypeEnum? paymentAdjustmentType = default(PaymentAdjustmentTypeEnum?), CommissionTypeEnum? commissionType = default(CommissionTypeEnum?), decimal commissionValue = default(decimal), decimal commissionFixedValue = default(decimal), string accountToken = default(string), PaymentTypeEnum? paymentType = default(PaymentTypeEnum?), PaymentCategoryEnum? paymentCategory = default(PaymentCategoryEnum?), string refundReason = default(string), string refundDetail = default(string), RefundTypeEnum? refundType = default(RefundTypeEnum?))
        {
            this.TransactionId = transactionId;
            this.MaskedMerchantId = maskedMerchantId;
        ...
        /// <summary>
        /// Gets or Sets MaskedMerchantId
        /// </summary>
        [DataMember(Name = "maskedMerchantId", EmitDefaultValue = false)]
        public string MaskedMerchantId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionDetailResponseRefundTransactionsDataInner {\n");
            sb.Append("  TransactionId: ").Append(TransactionId).Append("\n");
            sb.Append("  MaskedMerchantId: ").Append(MaskedMerchantId).Append("\n");
