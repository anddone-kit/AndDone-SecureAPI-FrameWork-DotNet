...
{
    /// <summary>
    /// PaymentLinkPaymentRequestTenderInfo
    /// </summary>
    [DataContract(Name = "PaymentLinkPaymentRequest_tenderInfo")]
    public partial class PaymentLinkPaymentRequestTenderInfo : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentLinkPaymentRequestTenderInfo" /> class.
        /// </summary>
        ...
        public PaymentLinkPaymentRequestTenderInfo(string bankName = default(string), string accountNumber = default(string), string routingNumber = default(string), string rawMICRLine = default(string), string accountType = default(string), string checkNumber = default(string), decimal accountCategory = default(decimal), string accountHolderName = default(string), string nameOnCheck = default(string), string cardHolderName = default(string), string cardType = default(string), string cardNumber = default(string), string cardExpiry = default(string), string cVData = default(string), string cVDataStatus = default(string), string trackData = default(string), string healthCareAccountType = default(string), decimal rxAmount = default(decimal), decimal visionAmount = default(decimal), decimal dentalAmount = default(decimal), decimal clinicAmount = default(decimal), decimal removeDiscounting = default(decimal), decimal amount = default(decimal), decimal tipAmount = default(decimal), decimal convenienceAmount = default(decimal), decimal taxPercent = default(decimal), string preAuthCode = default(string), string createAccountToken = default(string), string accountToken = default(string))
        {
        ...
        /// </summary>
        [DataMember(Name = "removeDiscounting", EmitDefaultValue = false)]
        public decimal RemoveDiscounting { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentLinkPaymentRequestTenderInfo {\n");
