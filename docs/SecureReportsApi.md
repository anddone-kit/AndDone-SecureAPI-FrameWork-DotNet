...
> void SecureReportsDownloadsPost (string xApiKey, string xAppKey, string origin, string xVersion, ReportDownloadRequest? reportDownloadRequest = null)
...
namespace Example
{
    public class SecureReportsDownloadsPostExample
    {
        public static void Main()
        {
            ...
            {
                // This API will add system report.
                apiInstance.SecureReportsDownloadsPost(xApiKey, xAppKey, origin, xVersion, reportDownloadRequest);
            }
...
{
    // This API will add system report.
    apiInstance.SecureReportsDownloadsPostWithHttpInfo(xApiKey, xAppKey, origin, xVersion, reportDownloadRequest);
}
catch (ApiException e)
{
...
| **404** | Not Found |  -  |
| **500** | Server Error |  -  |
| **2XX** | Successful CSV file download |  * Content-Type - The MIME type of the CSV file being downloaded <br>  |
