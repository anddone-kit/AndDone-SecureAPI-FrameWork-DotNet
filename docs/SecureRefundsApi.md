...
> RefundEligibility SecureRefundsEligibilityPost (string xApiKey, string xAppKey, string origin, string xVersion, TransactionRefundEligibilityRequest transactionRefundEligibilityRequest)
...
namespace Example
{
    public class SecureRefundsEligibilityPostExample
    {
        public static void Main()
        {
            ...
            {
                // This API return refund eligibility of a transaction.
                RefundEligibility result = apiInstance.SecureRefundsEligibilityPost(xApiKey, xAppKey, origin, xVersion, transactionRefundEligibilityRequest);
...
{
    // This API return refund eligibility of a transaction.
    ApiResponse<RefundEligibility> response = apiInstance.SecureRefundsEligibilityPostWithHttpInfo(xApiKey, xAppKey, origin, xVersion, transactionRefundEligibilityRequest);
...
# **SecureRefundsPost**
> TransactionResponse SecureRefundsPost (string xApiKey, string xAppKey, string origin, string xVersion, TransactionRefundRequest transactionRefundRequest)
...
namespace Example
{
    public class SecureRefundsPostExample
    {
        public static void Main()
        {
            ...
            var origin = "origin_example";  // string | an authorization header. Your origin IP address or URL. Must be configured with AndDone Administration
            var xVersion = "xVersion_example";  // string | x-version
            var transactionRefundRequest = new TransactionRefundRequest(); // TransactionRefundRequest | refund Detail

            try
            {
                // This API return refund a transaction.
                TransactionResponse result = apiInstance.SecureRefundsPost(xApiKey, xAppKey, origin, xVersion, transactionRefundRequest);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // This API return refund a transaction.
    ApiResponse<TransactionResponse> response = apiInstance.SecureRefundsPostWithHttpInfo(xApiKey, xAppKey, origin, xVersion, transactionRefundRequest);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
| **origin** | **string** | an authorization header. Your origin IP address or URL. Must be configured with AndDone Administration |  |
| **xVersion** | **string** | x-version |  |
| **transactionRefundRequest** | [**TransactionRefundRequest**](TransactionRefundRequest.md) | refund Detail |  |
