...
class PFCheckEndorsementsResponseItemPoliciesInner(BaseModel):
    """
    ...
    premium: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="Premium")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "CoverageTypeDescription": obj.get("CoverageTypeDescription"),
