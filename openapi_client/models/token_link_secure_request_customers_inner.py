...
class TokenLinkSecureRequestCustomersInner(BaseModel):
    """
    ...
    address: Optional[TokenLinkSecureRequestCustomersInnerAddress] = None
    __properties: ClassVar[List[str]] = ["firstName", "lastName", "email", "phone", "phoneCountryCode", "address"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "address": TokenLinkSecureRequestCustomersInnerAddress.from_dict(obj["address"]) if obj.get("address") is not None else None
        })
        return _obj
