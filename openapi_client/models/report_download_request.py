...
class ReportDownloadRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["reportId", "reportGenerationLogId", "fileCompress", "date"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "reportGenerationLogId": obj.get("reportGenerationLogId"),
            "fileCompress": obj.get("fileCompress"),
            "date": obj.get("date")
        })
        return _obj
