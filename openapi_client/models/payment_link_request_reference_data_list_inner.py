...
class PaymentLinkRequestReferenceDataListInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["referenceType", "referenceNumber", "referenceKey"]
    ...
    def reference_type_validate_enum(cls, value):
        ...
        if value not in set(['QuoteNumber', 'AccountNumber', 'PolicyNumber', 'InvoiceNumber', 'OtherNumber']):
            raise ValueError("must be one of enum values ('QuoteNumber', 'AccountNumber', 'PolicyNumber', 'InvoiceNumber', 'OtherNumber')")
        return value
