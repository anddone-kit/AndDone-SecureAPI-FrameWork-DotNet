...
class PaymentLinkRequestLineItemsInner(BaseModel):
    """
    PaymentLinkRequestLineItemsInner
    """ # noqa: E501
    line_item_type: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="lineItemType")
    ...
    __properties: ClassVar[List[str]] = ["lineItemType", "productId", "description", "quantity", "rate"]
