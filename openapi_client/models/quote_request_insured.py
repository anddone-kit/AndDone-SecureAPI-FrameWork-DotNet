...
class QuoteRequestInsured(BaseModel):
    """
    QuoteRequestInsured
    """ # noqa: E501
    agent_customer_number: StrictStr = Field(alias="agentCustomerNumber")
    email: StrictStr
    care_of: StrictStr = Field(alias="careOf")
    unique_id: Optional[StrictStr] = Field(default=None, alias="uniqueId")
    address: QuoteRequestInsuredAddress
    __properties: ClassVar[List[str]] = ["agentCustomerNumber", "email", "careOf", "uniqueId", "address"]
