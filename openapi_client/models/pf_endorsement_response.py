...
class PFEndorsementResponse(BaseModel):
    """
    ...
    item: Optional[PFEndorsementResponseItem] = None
    __properties: ClassVar[List[str]] = ["integrationID", "isSuccess", "message", "item"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "item": PFEndorsementResponseItem.from_dict(obj["item"]) if obj.get("item") is not None else None
        })
        return _obj
