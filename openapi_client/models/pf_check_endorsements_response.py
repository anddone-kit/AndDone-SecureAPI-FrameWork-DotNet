...
class PFCheckEndorsementsResponse(BaseModel):
    """
    ...
    is_endorsement_eligible: Optional[StrictBool] = Field(default=None, alias="isEndorsementEligible")
    message: Optional[StrictStr] = None
    item: Optional[PFCheckEndorsementsResponseItem] = None
    __properties: ClassVar[List[str]] = ["integrationID", "isSuccess", "isEndorsementEligible", "message", "item"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "isEndorsementEligible": obj.get("isEndorsementEligible"),
            "message": obj.get("message"),
            "item": PFCheckEndorsementsResponseItem.from_dict(obj["item"]) if obj.get("item") is not None else None
        })
        return _obj
