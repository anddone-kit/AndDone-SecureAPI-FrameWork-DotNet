...
class SecurePaymentDetailsResponseTransactionResult(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["success", "processorAuthCode", "traceNumber", "reasonCode", "reasonMessage"]
