...
class PaymentRequestPFR(BaseModel):
    """
    PaymentRequestPFR
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["entity", "reference", "quote", "accountNumber", "paymentType"]
    ...
    def payment_type_validate_enum(cls, value):
        ...
        if value not in set(['NA', 'DownPayment', 'InstallmentPayment', 'FeePayment', 'OtherPayment']):
            raise ValueError("must be one of enum values ('NA', 'DownPayment', 'InstallmentPayment', 'FeePayment', 'OtherPayment')")
        return value
