...
class PaymentBatchDetailsResponseTransactionDetailsInner(BaseModel):
    """
    ...
    transaction_date_time: Optional[StrictStr] = Field(default=None, alias="transactionDateTime")
    transaction_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="transactionAmount")
    __properties: ClassVar[List[str]] = ["transactionId", "transactionStatus", "transactionDateTime", "transactionAmount"]
