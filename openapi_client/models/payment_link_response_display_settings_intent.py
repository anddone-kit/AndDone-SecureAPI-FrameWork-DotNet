...
class PaymentLinkResponseDisplaySettingsIntent(BaseModel):
    """
    ...
    def payment_types_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['NotDefined', 'ACH', 'CreditCard', 'DebitCard', 'RTP']):
                raise ValueError("each list item must be one of ('NotDefined', 'ACH', 'CreditCard', 'DebitCard', 'RTP')")
        return value
