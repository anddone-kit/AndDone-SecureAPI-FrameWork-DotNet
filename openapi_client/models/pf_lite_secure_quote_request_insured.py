...
class PFLiteSecureQuoteRequestInsured(BaseModel):
    """
    ...
    is_cancellation_warning_via_text_enabled: Optional[StrictBool] = Field(default=None, alias="isCancellationWarningViaTextEnabled")
    address: PFLiteSecureQuoteRequestInsuredAddress
    __properties: ClassVar[List[str]] = ["id", "firstName", "lastName", "mobilePhoneNumber", "emailAddress", "isCancellationWarningViaTextEnabled", "address"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "isCancellationWarningViaTextEnabled": obj.get("isCancellationWarningViaTextEnabled"),
            "address": PFLiteSecureQuoteRequestInsuredAddress.from_dict(obj["address"]) if obj.get("address") is not None else None
        })
        return _obj
